               ...
               <div class="clearfix">
                   ...
                   <div class="pull-right upper-right clearfix">
                       ...
                       <div class="upper-column info-box">
                           ...
                           <ul>
                               <li>+91-9377662911</li>
                               <li><strong>modernmt.sales@gmail.com</strong></li>
                           </ul>
                       </div>
                       ...
                       <div class="upper-column info-box">
                           <div class="social-icons">
                               <a href="https://www.facebook.com/profile.php?id=100085589469795"><i class="fa fa-facebook-f"></i></a><!--
                               --><a href="https://www.instagram.com/modernrajkot/"><i class="fa fa-instagram"></i></a><!--
                               --><a href="https://www.linkedin.com/in/modern-machine-tools-318a02283/"><i class="fa fa-linkedin"></i></a>
                           </div><!-- /.social-icons -->
                       </div>
                   </div>
               </div>
                   ...
                   <nav class="main-menu">
                       ...
                       <div class="navbar-collapse collapse clearfix">
                           <ul class="navigation clearfix">
                               ...
                               <li><a href="projects-with-filter.php">Products</a></li>
