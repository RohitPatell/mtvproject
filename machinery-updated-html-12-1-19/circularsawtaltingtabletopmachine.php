...
<div class="page-wrapper">
    ...
    <section style="padding-bottom:0px;" class="project-single-section projectsinglesection">
        ...
        <div class="auto-container">
            <h2 style="color: black; padding: 10px;">Circular Saw Talting Table Top Machine</h2>
                    ...
                    <div class="single-item-carousel owl-carousel owl-theme">
                        <div class="slide">
                            <div style="display: flex;" class="image  twentyfivemmimg">
                                <img style="height:300px; width: 300px; border:1px solid #c9c9c9; margin-top:20px" src="images2/circular-saw-talting-table-top-machine.jpg" alt="" />
                                <div style="margin-top: 15px; text-align:justify" class="text threeeighttextt">
                                <!-- <h5>FRAME:</h5> -->
