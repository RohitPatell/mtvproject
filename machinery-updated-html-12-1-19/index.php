                        ...
                        <div class="box valign-middle">
                            <div class="content">
                                <div class="main-banner-content" data-animation="animated fadeInUp">
                                    <!-- <h3 class="title" >Warm welcome to</h3>
                                    <h1>Machinery</h1>
                                    <p class="text">Over 24 years experience and knowledge international standards, <br> technologicaly changes and industrial systems.</p>
                                    <a href="#" class="theme-btn btn-style-one">Read More</a>
                                    <a href="#" class="theme-btn btn-style-two">Market Sectors</a> -->
                                    <img src="images/top-slider01.jpg" alt="">
                        ...
                        <div class="box valign-middle">
                            <div class="content pull-right ">
                                <div class="main-banner-content light" data-animation="animated fadeInUp">
                                    ...
                                    <a href="#" class="theme-btn btn-style-one">Read More</a>
                                    <a href="#" class="theme-btn btn-style-two">Market Sectors</a> -->
                                    <img src="images/top-slider02.jpg" alt="">
                        ...
                        <div class="box valign-middle">
                            <div class="content ">
                                <div class="main-banner-content" data-animation="animated fadeInUp">
                                    ...
                                    <a href="#" class="theme-btn btn-style-one">Read More</a>
                                    <a href="#" class="theme-btn btn-style-two">Market Sectors</a> -->
                                    <img src="images/top-slider03.jpg" alt="">
                ...
                <div class="project-carousel owl-carousel owl-theme">
                    ...
                    <!-- <div class="project-block">
                        <div class="image-box">
                            ...
                            <div class="title-box">
                                <h3><a href="projects-single.html">Wide Range of Machinery</a></h3>
                ...
                <div class="item">
                    <div class="signle-testimonial-style-one">
                        <div class="inner-box">
                            <h2>Welcome                            </h2>
                            <p>Welcome
                                We Modern Machine Tools have completed 40 years of our journey in supplying quality machines and machine
                                tools with backing of reputed manufacturers from different part of the country, mainly we dealt with <a href="">Learn More</a></p>
                        </div> 
                    </div> 
                </div> 
                <div class="item">
                    <div class="signle-testimonial-style-one">
                        <div class="inner-box">
                            ...
                            <p>We have well equipped workshop with required machineries and equipments with highly qualified team of engineers. <a href="">Learn More About This</a></p>
                            <img src="http://localhost/mmtrajkot/img/image1.jpg" class="company-logo" alt="Awesome Image"/>
                        </div> 
                    </div> 
                </div> 
                <div class="item">
                    <div class="signle-testimonial-style-one">
                        <div class="inner-box">
                            ...
                            <p>Creating best products today requires much more then a product design tool. Not only you need a full set of intuitive MCAD tools, <a href="">Learn More About This</a></p>
                            <img src="http://localhost/mmtrajkot/img/image2.jpg" class="company-logo" alt="Awesome Image"/>
                        </div> 
                    </div> 
                </div>  -->
    ...
    <!-- <div class="item">
                    <div class="signle-testimonial-style-one">
                        <div class="inner-box">
                            ...
                            <img src="images/testimonials/c-1.png" class="company-logo" alt="Awesome Image"/>
                        </div>
                    </div> 
                </div> 
                <div class="item">
                    <div class="signle-testimonial-style-one">
                        <div class="inner-box">
                            <img src="images/testimonials/2.png" alt="Awesome Image" class="client-image"/>
                            <h3>Vanita Scheve</h3>
                            ...
                            <img src="images/testimonials/c-2.png" class="company-logo" alt="Awesome Image"/>
                        </div> 
                    </div> 
                </div> 
                <div class="item">
                    <div class="signle-testimonial-style-one">
                        <div class="inner-box">
                            <img src="images/testimonials/3.png" alt="Awesome Image" class="client-image"/>
                            ...
                            <img src="images/testimonials/c-3.png" class="company-logo" alt="Awesome Image"/>
                        </div> 
                    </div> 
                </div> 
                <div class="item">
    ...
    <!-- <section class="request-qoute-title-block bg-gray">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <div class="text">Your details are kept strictly confidential as per our company privacy policy, Pleasure & praising <br> was we will give you a complete.</div> 
            </div> 
        </div> 
    </section>  -->
    <!-- Contact Section -->
