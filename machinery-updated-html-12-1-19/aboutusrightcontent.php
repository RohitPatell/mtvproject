...
<div style="margin-top:15px;"><h3 style="background-color: black; padding:5px; padding-left:14px;color:white;">Modern Machine Tools</h3></div>
  <div  class="list-group">
    ...
    <a  href="missionvision.php" class="list-group-item list-group-item-secondary">Mission & Vision</a>
    <a  href="applicationandusage.php" class="list-group-item list-group-item-dark">Application & Usage</a>
