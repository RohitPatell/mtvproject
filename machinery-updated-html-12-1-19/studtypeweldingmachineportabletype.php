...
<div class="page-wrapper">
    ...
    <section class="project-single-section">
        ...
        <div class="auto-container">
            <h2 style="color: black; padding: 10px;">Stud Type Welding Machine Portable Type</h2>
            ...
            <div class="inner-container">
                ...
                <div class="upper-box">
                    <div class="single-item-carousel owl-carousel owl-theme">
                        <div class="slide">
                            <div class="image">
                                <img style="height:700px; width: 1000px; margin-top:20px" src="images2/stud-type-welding-machine-portable-type.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div style="width:100%;" class="content-column col-lg-9 col-md-8 col-sm-12 col-xs-12">
                        <div class="inner-column">
                            <div class="text">
                                <!-- <h5>FRAME:</h5> -->
                                <p>Modern Machine Tools 120 Amps. Machine is best suited for small repair and maintenance jobs, where portability is of prime consideration. This machine type is best utilised in intermittent operations.</p>
