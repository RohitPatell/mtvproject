        ...
        <header class="main-header style-two">
            ...
            <section class="project-single-section">
                ...
                <div class="auto-container">
                    <h2 style="color: black; padding: 10px;">Surface Planner Machine</h2>
                    ...
                    <div class="inner-container">
                        ...
                        <div class="upper-box">
                            <div class="single-item-carousel owl-carousel owl-theme">
                                <div class="slide">
                                    <div class="image">
                                        <img style="height:700px; width: 1000px; margin-top:20px" src="images2/surface-planner-machine.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
