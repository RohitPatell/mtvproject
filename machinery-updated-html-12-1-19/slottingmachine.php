...
<div class="page-wrapper">
  ...
  <section class="project-single-section">
    ...
    <div class="auto-container">
      <h2 style="color: black; padding: 10px;">Slotting Machine</h2>
    ...
    <div class="container mt-5">
      <table class="table table-bordered">
        <tbody>
          <tr>
            <td class="alignLeft" width="200">STROKE</td>
            <td class="alignLeft lastColumn">Fixed Stroke 10mm to 250mm</td>
          </tr>
          <tr>
            <td class="alignLeft">LONGITUDINAL MOVEMENT</td>
            <td class="alignLeft lastColumn">230 mm</td>
          </tr>
          <tr class="even">
            <td class="alignLeft">CROSS MOVEMENT</td>
            <td class="alignLeft lastColumn">230 mm</td>
          </tr>
          <tr>
            <td class="alignLeft">SPEED ADJUSTMENT</td>
            <td class="alignLeft lastColumn">3 Speed</td>
          </tr>
          <tr class="even">
            <td class="alignLeft">RAM ADJUSTMENT</td>
            <td class="alignLeft lastColumn">250 mm</td>
          </tr>
          <tr>
            <td class="alignLeft">H.P.</td>
            <td class="alignLeft lastColumn">1.5 H.P.</td>
          </tr>
          <tr class="even">
            <th colspan="2" class="alignLeft">EXTRA EQUIPMENT</th>
          </tr>
          <tr>
            <td class="alignLeft">ROTARY TABLE WITH 36:1 RATIO</td>
            <td class="alignLeft lastColumn">250 mm Diameter</td>
          </tr>
        </tbody>
      </table>
      <h5>Extra Wquipments:
      ...
      <p>Electric Motor, True Chuck, Switch, 'V' Belt etc.</p>
    </div>
