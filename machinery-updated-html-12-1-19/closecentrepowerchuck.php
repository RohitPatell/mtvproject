...
<div class="page-wrapper">
    ...
    <section style="padding-bottom: 10px;" class="project-single-section">
        ...
        <div class="auto-container">
            <h2 style="color: black; padding: 10px;">Close Centre Power Chuck</h2>
                ...
                <div class="row clearfix">
                    ...
                    <div style="width:100%;" class="content-column col-lg-9 col-md-8 col-sm-12 col-xs-12">
                        <div class="inner-column">
                            ...
                            <div class="container">
                                <img src="images2/close-centre-power-chuck-diagram.jpg" alt="">
                            </div>
                            <div class="container">
                                <img src="images2/close-centre-power-chuck-spec.jpg" alt="">
                            </div>
